                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <NavLink to="/" className={({isActive}) => `hover:underline hover:text-orange-700 ${isActive ? "text-green-500" : "text-gray-700"}`}>
                                        Home
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/about" className={({isActive}) => `hover:underline hover:text-orange-700 ${isActive ? "text-green-500" : "text-gray-700"}`}>
                                        About
                                    </NavLink>
                                </li>
                                <li>
                                    <NavLink to="/contact" className={({isActive}) => `hover:underline hover:text-orange-700 ${isActive ? "text-green-500" : "text-gray-700"}`}>
                                        Contact
                                    </NavLink>
                                </li>
                            </ul>
