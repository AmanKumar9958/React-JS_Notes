...
function App() {
  ...
  const currencyInfo = useCurrencyInfo(from)  // we passed the 'from' because we have to change the form currency..
  ...
  return (
    <div className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat" style={{backgroundImage: `url('https://images.pexels.com/photos/534216/pexels-photo-534216.jpeg?auto=compress&cs=tinysrgb&w=600')`}}>
